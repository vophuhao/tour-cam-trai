...
import { createCampsite, deleteCampsite, getAllActivities, getAllAmenities, getMyCampsites, updateCampsite } from "@/lib/client-actions";
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{stats.instant}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {filteredCampsites.map((campsite) => (
                            <Card key={campsite._id} className="overflow-hidden transition-shadow hover:shadow-lg">
                                        ...
                                        <div className="flex flex-1 flex-col p-6">
                                            <div className="flex flex-1 flex-col">
                                                ...
                                                <div className="mt-4 flex items-center text-sm text-gray-600">
                                                    ...
                                                    <span className="line-clamp-1">
                                                        {campsite.location.address}, {campsite.location.city}, {campsite.location.state}
                                                    </span>
                                                </div>
                                                ...
                                                <div className="mt-4 grid grid-cols-2 gap-4 border-t pt-4 sm:grid-cols-4">
                                                    <div>
                                                        ...
                                                        <p className="mt-1 font-semibold">{campsite.views}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs text-gray-500">Tiện nghi</p>
                                                        <p className="mt-1 font-semibold">{campsite.amenities.length}</p>
                                                    </div>
                                                    <div className="col-span-2">
                                                        <p className="text-xs text-gray-500">Giá/đêm</p>
                                                        <p className="mt-1 text-lg font-bold text-emerald-600">
                                                            {formatPrice(campsite.pricing.basePrice)} {campsite.pricing.currency}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="mt-4 flex gap-2 border-t pt-4">
                                                ...
                                                <Button
                                                    ...
                                                    size="sm"
                                                    className="flex-1"
                                                    onClick={() => window.open(`/campsites/${campsite.slug}`, '_blank')}
                                                >
            ...
            <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription asChild> {/* ✅ Add asChild */}
                            <div className="space-y-2"> {/* ✅ Change from implicit <p> to <div> */}
                                <p>
