...
// ✅ Thêm "completed" vào statusOrder
const statusOrder = ["processing", "confirmed", "shipping", "delivered", "completed"];
...
export default function OrderDetail(): JSX.Element {
  ...
  const getCurrentStatusIndex = (status?: string) => {
    if (!status) return -1;
    // ✅ Chỉ loại bỏ cancelled và cancel_request
    if (status === "cancelled" || status === "cancel_request") return -1;
