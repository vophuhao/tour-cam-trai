...
const notificationIcons: Record<NotificationType, any> = {
  ...
  booking_payment_received: DollarSign,
  guest_checked_in: UserCheck,
  guest_checked_out: UserCheck,
  guest_cancelled_booking: UserX,
  new_review_received: Star,
  property_approved: Home,
  property_rejected: AlertCircle,
  payout_processed: DollarSign,
  booking_reminder: Bell,
  guest_message: MessageSquare,
  property_performance: TrendingUp,
  // Guest notifications
